...
@section('title') Cập nhật loại thuốc @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật loại thuốc</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('types.index') }}" title="Quản lý loại thuốc" data-toggle="tooltip" data-placement="top">Quản lý loại thuốc</a></li>
                                    <li class="breadcrumb-item active">Cập nhật loại thuốc</li>
                                </ol>
                            </div>

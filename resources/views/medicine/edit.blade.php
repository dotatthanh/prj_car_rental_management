...
@section('title') Cập nhật thuốc @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật thuốc</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('medicines.index') }}" title="Quản lý thuốc" data-toggle="tooltip" data-placement="top">Quản lý thuốc</a></li>
                                    <li class="breadcrumb-item active">Cập nhật thuốc</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('medicines.update', $data_edit->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @include('medicine._form')

    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật giá gửi xe</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('parking_rates.index') }}"
                                            title="Quản lý giá gửi xe" data-toggle="tooltip" data-placement="top">Quản lý
                                            giá gửi xe</a></li>
                                    <li class="breadcrumb-item active">Cập nhật giá gửi xe</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="{{ route('parking_rates.update', $data_edit->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @include('parking-rate._form', ['routeType' => 'update'])
                        </form>
                    </div>
                </div>
                <!-- end row -->

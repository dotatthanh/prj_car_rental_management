    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm chỗ gửi xe</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('parking_slots.index') }}"
                                            ...
                                            chỗ gửi xe</a></li>
                                    <li class="breadcrumb-item active">Thêm chỗ gửi xe</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="{{ route('parking_slots.store') }}" enctype="multipart/form-data">
                            @include('parking-slot._form', ['routeType' => 'create'])
                        </form>
                    </div>
                </div>
                <!-- end row -->

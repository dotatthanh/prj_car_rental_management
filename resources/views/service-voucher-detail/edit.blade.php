...
@section('title') Cập nhật chi tiết phiếu dịch vụ @endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật chi tiết phiếu dịch vụ</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Cập nhật chi tiết phiếu dịch vụ</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="repeater custom-validation" method="POST" action="{{ route('service_voucher_details.update', $data_edit->id) }}" enctype="multipart/form-data">
                            @method('PUT')

    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div style=" width : 800px;">
                <div class="col-6" style="padding : 20px;">
                    ...
                    <div style= " position: absolute; right: -800px; top: 0px; padding : 20px;">
                        ...
                        @if (auth()->guard('web')->user())
                            <button type="button" data-toggle="modal" data-target="#booking"
                                class="btn btn-primary mt-2">Đặt thuê xe</button>
                        @else
                            <div class="col-12">
                                <p class="d-block mt-2 font-weight-bold"><a href="{{ route('web.login') }}"
                                        class="text-primary">Đăng nhập</a> để đặt thuê xe!</p>
                            </div>
                        @endif
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="from_date">Ngày bắt đầu thuê <span
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="to_date">Ngày kết thúc thuê <span
                                                        class="text-danger">*</span></label>
            ...
            <div class="cloum" style="width: 500px;">
                <p class="text-success mt-2" style="font-size: 20px; width : 300px;">Số lượng:
                    {{ $room->hired }}/{{ $room->amount }} người</p>
                <p class="text-danger mt-2" style="font-size: 20px; with: 100px;">Giá:
            ...
            <div class="cloum" style="right: 100px; ">
                ...
                @foreach ($room->types as $type)
                    <label class="form-check-label" for="type{{ $type->type->id }}">
                        <p id="id_1" style="width: 200px; font-size: 25px;">+ {{ $type->type->name }}
                        <p>
                    </label>
                @endforeach
            </div>
            ...
            <!-- Tiện ích-->
            <div class="cloum">
                <h2 style="font-size: 40px;"><img
                        src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-utilities-industry-flaticons-lineal-color-flat-icons.png" />Tiện
                    ích</h2>
                @foreach ($room->utilities as $utiliti)
                    <label class="form-check-label" for="type{{ $utiliti->utiliti->id }}">
                        <p id="id_1" style="width: 300px; font-size: 25px;">+ {{ $utiliti->utiliti->name }}
                        <p>
                    </label>
                @endforeach
            </div>
            ...
            <div class="cloum" style="position: right;">
                <h2 style="font-size: 40px;"><img
                        src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-hobby-lifestyles-flaticons-lineal-color-flat-icons.png" />
                    Sở thích</h2>
                @foreach ($room->hobbys as $hobby)
                    <label class="form-check-label" for="type{{ $hobby->hobby->id }}">
                        <p id="id_1" style="width: 200px;font-size: 25px;">+ {{ $hobby->hobby->name }}
                        <p>
                    </label>
                @endforeach
            </div>

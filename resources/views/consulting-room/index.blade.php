...
@section('title') Quản lý phòng khám @endsection
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Danh sách phòng khám</h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="GET" action="{{ route('consulting_rooms.index') }}">
                                    <div class="row mb-2">
                                        <div class="col-sm-5">
                                            <div class="search-box mr-2 mb-2 d-inline-block">
                                                <div class="position-relative">
                                                    <input type="text" name="search" class="form-control" placeholder="Nhập tên phòng khám">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($consulting_rooms as $consulting_room)
                                                <tr>
                                                    ...
                                                    <td>{{ $consulting_room->code }}</td>
                                                    <td>
                                                        {{ $consulting_room->name }}
                                                    </td>

...
@section('title') Thêm tài xế @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm tài xế</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Thêm tài xế</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('drivers.store') }}" enctype="multipart/form-data">
                                    ...
                                    @include('driver._form', ['routeType' => 'create'])

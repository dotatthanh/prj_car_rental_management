                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="date" name="date" type="text" class="form-control" value="{{ date("d-m-Y", strtotime($data_edit->date)) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="time" name="time" type="text" class="form-control" value="{{ date("H:i", strtotime($data_edit->time)) }}">
                                            </div>
                                        </div>
                                    </div>

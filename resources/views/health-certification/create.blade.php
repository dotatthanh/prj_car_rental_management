...
@section('title') Thêm giấy khám bệnh @endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm giấy khám bệnh</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Thêm giấy khám bệnh</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="{{ route('health_certifications.store') }}" enctype="multipart/form-data">

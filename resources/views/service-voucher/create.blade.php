...
@section('title') Thêm phiếu dịch vụ @endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm phiếu dịch vụ</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Thêm phiếu dịch vụ</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="{{ route('service_vouchers.store') }}" enctype="multipart/form-data">
